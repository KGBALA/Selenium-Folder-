...
public class zohoTest {
	...
	String path = "/Users/edilmasimov/Desktop/SELENIUM/TESTING-MAVEN/selenium-maven-zoho/src/test/resources/config.properties";
	String excelPath = "/Users/edilmasimov/Desktop/SELENIUM/TESTINGDATA/testData2.xlsx";
	Properties prop;
	...
	public void printExcel() {
		...
		List<WebElement> id = driver.findElements(By.cssSelector("#reportTab>tbody> tr>td:nth-child(1)"));
		List<WebElement> name = driver.findElements(By.cssSelector("#reportTab>tbody> tr>td:nth-child(2)"));
		List<WebElement> email = driver.findElements(By.cssSelector("#reportTab>tbody> tr>td:nth-child(3)"));
		List<WebElement> phone = driver.findElements(By.cssSelector("#reportTab>tbody> tr>td:nth-child(4)"));
		List<WebElement> salary = driver.findElements(By.cssSelector("#reportTab>tbody> tr>td:nth-child(5)"));
