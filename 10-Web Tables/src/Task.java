...
public class Task {
	...
	public static void main(String[] args) {
		...
		List<WebElement> rows = driver.findElements(By.xpath(
				"//*[@id=\"page\"]/div/div/div/section/div[2]/article/div/div[2]/div[1]/div[1]/div[1]/table/tbody/tr"));
		System.out.println(rows.size());

		List<WebElement> columns = driver.findElements(By.xpath(
				"//*[@id=\"page\"]/div/div/div/section/div[2]/article/div/div[2]/div[1]/div[1]/div[1]/table/tbody/tr[1]/td"));
